...
function wsuartbridge(websocket)
{
	this.ws = websocket;
...
wsuartbridge.prototype.ws=null;
...
*/
wsuartbridge.prototype.ReadMem = function(adr,len,callback)
{
	this.cb = callback;
 ...
 *		callback: function cb for controller response
*/
wsuartbridge.prototype.WriteMem = function(adr,val,callback)
{
	this.cb = callback;
